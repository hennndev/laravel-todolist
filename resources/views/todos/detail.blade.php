  ...
  <section class="mt-10">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-3">
        ...
        <a 
          href="{{ route("todos.edit", "$data->id") }}" class="text-white py-2 px-4 rounded-md hover:bg-blue-600 duration-200 {{ $data->is_done ? "line-through bg-gray-500 hover:bg-gray-500 cursor-default pointer-events-none" : "bg-blue-500" }}">
          Edit Todo
        </a>
    ...
    <div class="mt-10">
      ...
      <p class="mb-2">End time: <span class="text-lg font-semibold text-[#222]">{{ $data->end_time ? $formatted_time($data->end_time) : "-" }}</span></p>
    </div>
    
    <x-tasks.task-list :data="$data"/>
